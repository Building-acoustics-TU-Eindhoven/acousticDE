...
This method allows for an efficient way to calculate acoustics parameters in the room (e.g. sound pressure level and reverberation time) and for more accurate solutions of these parameters compared to the statistical methods of Sabine and Eyring. Moreover, it provides spatial and temporal distributions of the sound energies in the rooms while keeping the computational cost reasonable. 
