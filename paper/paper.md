...
The diffusion equation model has grown to be an effective compromise, providing physically meaningful spatial and temporal distributions of acoustic energy while remaining computationally efficient in the high-frequency range [@Foy2016IncludingApproach], [@Mou2023AnSpaces], [@SuGul2020ComparativeStations]. However, despite its demonstrated usefulness in the literature, accessible and user-friendly software implementations of the diffusion equation model have been non existent [@Hornikx2024] or somewhat limited. In fact, most implementations of the diffusion equation are commercial tools (e.g. COMSOL or Femlab toolbox for Matlab) and an other open source is in experimental version ([MD_Octave numerical code](https://i-simpa.univ-gustave-eiffel.fr/presentation/embedded-codes/md)). 
